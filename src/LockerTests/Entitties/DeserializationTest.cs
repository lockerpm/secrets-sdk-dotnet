...
{
    public class DeserializationTest : BaseLockerTest
    {
        [Fact]
        public void TestStubWithIdDirect()
        {
            string json = "{\"some_ref\":{\"id\":\"xyz\"}}";
            var entity = LockerEntity.FromJson<MyEntity>(json);
        ...
        public class MyEntity : LockerEntity<MyEntity>, IHasId
        {
            [JsonProperty("id")] public string Id { get; set; }

            [JsonProperty("some_integer")] public long SomeInteger { get; set; }

            [JsonProperty("some_longinteger")] public long SomeLonginteger { get; set; }

            [JsonProperty("some_boolean")] public bool SomeBoolean { get; set; }

            [JsonProperty("some_number")] public decimal SomeNumber { get; set; }

            [JsonProperty("some_decimal_string")] public decimal SomeDecimalString { get; set; }

            [JsonProperty("some_string")] public string SomeString { get; set; }

            [JsonProperty("some_ref")] public MyEntity SomeRef { get; set; }

            [JsonProperty("some_literal")] public string SomeLiteral { get; set; }

            [JsonProperty("some_nullable")] public string SomeNullable { get; set; }

            [JsonProperty("some_string_array")] public List<string> SomeStringArray { get; set; }

            [JsonProperty("some_ref_array")] public List<MyEntity> SomeRefArray { get; set; }
            ...
            [JsonProperty("some_enum")] public string SomeEnum { get; set; }

            [JsonProperty("some_map")] public Dictionary<string, string> SomeMap { get; set; }

            [JsonProperty("some_object")] public MyEntitySomeObject SomeObject { get; set; }

            [JsonProperty("some_list_object")] public LockerList<MyEntity> SomeListObject { get; set; }
        ...
        public class MyEntitySomeObject : LockerEntity<MyEntitySomeObject>
        {
            [JsonProperty("some_string")] public string SomeString { get; set; }
        }
    }
