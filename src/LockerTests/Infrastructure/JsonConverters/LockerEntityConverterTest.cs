namespace LockerTests
{
    ...
    public class LockerEntityConverterTest : BaseLockerTest
    {
        [Fact]
        ...
        private class TestObject : LockerEntity<TestObject>
        {
            [JsonProperty("supported_field")] public int? SupportedField { get; set; }
            [JsonProperty("child")] public TestChildObject Child { get; set; }
        }

        private class TestChildObject : LockerEntity<TestChildObject>
        {
            [JsonProperty("child_supported_field")]
            public int ChildSupportedField { get; set; }
        }
    }
}