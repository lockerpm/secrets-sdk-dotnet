namespace Locker.Infrastructure
{
    ...
    /// <summary>
    /// This converter can be used to deserialize any Locker object. It is mainly useful for
    ...
    public class LockerObjectConverter : JsonConverter
    {
        ...
        {
            throw new NotSupportedException("LockerObjectConverter should only be used while deserializing.");
        }
            ...
            JsonSerializer serializer)
        {
            ...
            Type concreteType = LockerTypeRegistry.GetConcreteType(objectType, objectValue);
