namespace Locker
{
    ...
    /// <summary>
    /// Base class for Locker options classes, i.e. classes representing parameters for
    /// requests.
    /// </summary>
    ...
    public class BaseOptions : INestedOptions
    {
        ...
        [JsonExtensionData]
        public IDictionary<string, object> ExtraParams { get; set; } = new Dictionary<string, object>();
        ...
        /// specific fields in the response.
        /// </summary>
